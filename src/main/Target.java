...
public class Target implements Locatable{
	public final static Font UNIT_LABEL_FONT = new Font("Arial", Font.PLAIN, 11);
	...
	public void draw(Graphics2D g, GameWindow window){
		if (target instanceof Unit){
			...
			if (targetVisible){
				...
				int age = getAge();
				if (age >= Main.targetFadeTime)
					return;
				length = size;
				g.setColor(new Color(255, 0, 0, 255-250*age/Main.targetFadeTime));
			}
